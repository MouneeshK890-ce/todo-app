...
const todoSlice = createSlice({
    ...
    reducers: {
         ...
         addTodo : (state, action) => {
            const newTodo = { id: crypto.randomUUID(), text: action.payload.trim(), completed: false, createdAt: new Date().toISOString(), updatedAt: new Date().toISOString()};
...
export const {setIsAddingTodo, addTodo, toggleTodo, deleteTodo, updateTodo, setFilter, clearCompleted, markAllComplete} = todoSlice.actions;
